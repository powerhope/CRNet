...
#     torch.save(model.state_dict(), 'cat.pth')
#     print(y.size())
#################################################################################################第四次实验加入channelattention，只在步长为2处
# import torch
# import torch.nn as nn
# from torch.nn import init
# import math
...
#         else:
    ...
    def init_weight(self, pretrain_model):
        ...
        self_state_dict = self.state_dict()
        sub_list = list(state_dict.keys())[:673]#673对应CRnet564,547对应CRnet453,421对应CRnet342,295对应CRnet222
        for k, v in state_dict.items():
            if k in sub_list:
